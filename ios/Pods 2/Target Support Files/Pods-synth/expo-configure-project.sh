...
with_node \
  ...
  --target "/Users/colesprout/Documents/2024-2025-classes/CS/CS337U/synth/ios/Pods/Target Support Files/Pods-synth/ExpoModulesProvider.swift" \
  --entitlement "/Users/colesprout/Documents/2024-2025-classes/CS/CS337U/synth/ios/synth/synth.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-av" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-splash-screen" "expo-web-browser"
